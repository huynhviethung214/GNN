...
@njit()
def fixSynapses(W, P, R, nodeIdc, nInputs, nOutputs):
    for n0 in nodeIdc:
        for n1 in nodeIdc:
            if n0 != n1:
                decayRateOfData = np.abs(R[n0] / magnitude(P[n0], P[n1]))
                if decayRateOfData <= 1e-2 and W[n0, n1] != 0:
                    W[n0, n1] = 0.
                elif decayRateOfData > 1e-2 and W[n0, n1] == 0:
